...
class MySQLiConnector extends Connector implements ConnectorInterface
{
    ...
    public function connect(array $config)
    {
        ...
        if (isset($config['connection']) && is_a($config['connection'], mysqli::class)) {
            ...
            // We need to grab the MySQLi options that should be used while making the brand
            // new connection instance. The MySQLi options control various aspects of the
